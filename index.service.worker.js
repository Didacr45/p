...
/** @type {string} */
const CACHE_VERSION = '1778950985|1137714505';
/** @type {string} */
const CACHE_PREFIX = 'Skyline Chase-sw-cache-';
...
/** @type {string[]} */
const CACHEABLE_FILES = ["index.wasm","index.pck","index.side.wasm","libgdsqlite.web.template_debug.wasm32.nothreads.wasm"];
